    ...
    <>
      ...
      <nav className={styles.navigationMobile}>
        ...
        <div className={styles.mobileMenu}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24.5" height="17.248" viewBox="0 0 24.5 17.248">
            <g id="Group_10288" data-name="Group 10288" transform="translate(-48.5 -16.152)">
              <line id="Line_2" data-name="Line 2" x1="22.5" transform="translate(49.5 17.152)" fill="none" stroke="#fff" stroke-linecap="round" stroke-width="2"/>
              <line id="Line_3" data-name="Line 3" x1="22.5" transform="translate(49.5 24.777)" fill="none" stroke="#fff" stroke-linecap="round" stroke-width="2"/>
              <line id="Line_4" data-name="Line 4" x1="22.5" transform="translate(49.5 32.4)" fill="none" stroke="#fff" stroke-linecap="round" stroke-width="2"/>
            </g>
          </svg>
        </div>
